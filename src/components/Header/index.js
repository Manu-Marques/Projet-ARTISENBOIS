        ...
        <ul>
          ...
          <li><NavLink to="/cuisines">Cuisine</NavLink>
            <div className="sub_menu">
              ...
              <div className="col">
                <NavLink to="/cuisines/buffet" className="col_navigation">Buffet</NavLink>
              </div>
              <div className="col">
                <NavLink to="/cuisines/meuble-bois-massif" className="col_navigation">Meuble bois massif</NavLink>
              </div>
              <div className="col">
                <NavLink to="/cuisines/plan-de-travail" className="col_navigation">Plan de travail</NavLink>
              </div>
              <div className="col">
                <NavLink to="/cuisines/meuble-rangement" className="col_navigation">Meuble rangement</NavLink>
              </div>
            </div>
          </li>
        </ul>
